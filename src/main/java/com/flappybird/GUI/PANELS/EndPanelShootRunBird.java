 ...
 * @author Emanuela
 */
public class EndPanelShootRunBird extends JPanel {
    ...
    public EndPanelShootRunBird(FlappyBirdFrame pFlappyBirdFrame) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawString(getBestScore(flappyBirdFrame.gamePanelShootRunBirds.game.player.getNickname()) + "", this.getWidth() / 2 + 75, this.getHeight() / 2 + 30);
    ...
    private class EndMouseListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            if (newMatch.isClicked(e)) {
                ...
                flappyBirdFrame.switchPanel(flappyBirdFrame.gamePanelShootRunBirds, flappyBirdFrame.endPanelShootRunBird);
                flappyBirdFrame.gamePanelShootRunBirds.resetGame();
            }

            if (home.isClicked(e)) {

                flappyBirdFrame.switchPanel(flappyBirdFrame.choiceGamesPanel, flappyBirdFrame.endPanelShootRunBird);
                flappyBirdFrame.gamePanelShootRunBirds.resetGame();
            }
    ...
    private int getBestScore(String name){
        ...
        try{            
            ...
            String sql = "SELECT max(punteggio) FROM punteggio WHERE id_player = " + id + " AND id_gioco = 3";
