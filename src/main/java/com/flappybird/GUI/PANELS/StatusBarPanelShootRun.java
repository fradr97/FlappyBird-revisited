...
public class StatusBarPanelShootRun extends JPanel {
    ...
    public StatusBarPanelShootRun(FlappyBirdFrame pFlappyBirdFrame) {
    ...
    private class StatusPanelListener extends MouseAdapter {
        ...
        public void mouseReleased(MouseEvent e) {
            if (pause.isClicked(e)) {
                flappyBirdFrame.switchPanel(flappyBirdFrame.stopPanelShootRunBird, flappyBirdFrame.gamePanelShootRunBirds);
                flappyBirdFrame.gamePanelShootRunBirds.stopColumn();
                flappyBirdFrame.gamePanelShootRunBirds.stopTimer();
            }
