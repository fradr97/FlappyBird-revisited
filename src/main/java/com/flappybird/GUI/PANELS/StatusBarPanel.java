...
public class StatusBarPanel extends JPanel {
    ...
    public StatusBarPanel(FlappyBirdFrame pFlappyBirdFrame) {
    ...
    private class StatusPanelListener extends MouseAdapter {
        ...
        public void mouseReleased(MouseEvent e) {
            if (pause.isClicked(e)) {
                flappyBirdFrame.switchPanel(flappyBirdFrame.stopPanel, flappyBirdFrame.gamePanelFlappyClassic);
                flappyBirdFrame.gamePanelFlappyClassic.stopDown();
                flappyBirdFrame.gamePanelFlappyClassic.stopColumn();

                flappyBirdFrame.gamePanelFlappyClassic.stopTimer();
                flappyBirdFrame.gamePanelFlappyClassic.stopSpeed();
        ...
        public void run() {
            ...
            while (running) {
                ...
                try {
                    ...
                    Logger.getLogger(StatusBarPanel.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
