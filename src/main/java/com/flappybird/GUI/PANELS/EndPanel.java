...
public class EndPanel extends JPanel {
    ...
    public EndPanel(FlappyBirdFrame pFlappyBirdFrame) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawString(getBestScore(flappyBirdFrame.gamePanelFlappyClassic.game.player.getNickname()) + "", this.getWidth() / 2 + 75, this.getHeight() / 2 + 30);
    ...
    private class EndMouseListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            if (newMatch.isClicked(e)) {
                ...
                flappyBirdFrame.switchPanel(flappyBirdFrame.gamePanelFlappyClassic, flappyBirdFrame.endPanel);
                flappyBirdFrame.gamePanelFlappyClassic.resetGame();
            }
            if (home.isClicked(e)) {

                flappyBirdFrame.switchPanel(flappyBirdFrame.choiceGamesPanel, flappyBirdFrame.endPanel);
                flappyBirdFrame.gamePanelFlappyClassic.resetGame();
            }
            if (exit.isClicked(e)) {
                exit(0);
    ...
    private int getBestScore(String name){
        ...
        try{            
            ...
            String sql = "SELECT max(punteggio) FROM punteggio WHERE id_player = " + id + " AND id_gioco = 1";
