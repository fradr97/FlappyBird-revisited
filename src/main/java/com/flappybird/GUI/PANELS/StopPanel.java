...
public class StopPanel extends JPanel {
    ...
    public StopPanel(FlappyBirdFrame pFlappyBirdFrame) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawString(flappyBirdFrame.gamePanelFlappyClassic.game.player.getScore() + "", this.getWidth() / 2 - 25, this.getHeight() / 2 - 50);
    ...
    private class StopMouseListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (newMatch.isClicked(e)) {
                flappyBirdFrame.gamePanelFlappyClassic.statusBarPanel.pause.isActive(false);
                flappyBirdFrame.switchPanel(flappyBirdFrame.gamePanelFlappyClassic, flappyBirdFrame.stopPanel);
                flappyBirdFrame.gamePanelFlappyClassic.resetGame();
            }

            if (resumeGame.isClicked(e)) {
                flappyBirdFrame.switchPanel(flappyBirdFrame.gamePanelFlappyClassic, flappyBirdFrame.stopPanel);
                flappyBirdFrame.gamePanelFlappyClassic.startTimer();
                flappyBirdFrame.gamePanelFlappyClassic.startColumn();
                flappyBirdFrame.gamePanelFlappyClassic.startDown();
                flappyBirdFrame.gamePanelFlappyClassic.startSpeed();
                flappyBirdFrame.gamePanelFlappyClassic.bird.setActiveJump(true);
            }
