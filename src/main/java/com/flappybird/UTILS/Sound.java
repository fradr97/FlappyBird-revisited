...
public class Sound {
     ...
     *
     * @return Un oggetto di tipo Clip che permette di gestire il suono
     * @throws SoundException Se non Ã¨ possibile ottenere un Clip dal suono
     */
     ...
     * gestire con comoditÃ  una collezione di suoni. Ad ogni nuovo suono
     * aggiunto a tale struttura dati Ã¨ necessario associare un nome mnemonico
     ...
     * @return Un oggetto di tipo Clip che permette di gestire il suono
     * @throws SoundException Se non Ã¨ possibile ottenere un Clip dal file
     */
